...
```bash
mkdir -p ~/arkt && chmod 777 ~/arkt && cd ~/arkt && curl -sSL https://raw.githubusercontent.com/arkt-7/NoPcWinstall/main/nopcwinstall -o nopcwinstall && chmod 777 nopcwinstall && su -c "./nopcwinstall"
```
> [!NOTE]
